...
include 'connection.php';
    ...
    if(isset($_POST['submit'])){
        ...
        $emailquery = "select * from reg-form where email='$email' ";
        $query = mysqli_query($conn,$emailquery);

        $emailcount = mysqli_num_rows();
        if($emailcount>0){
        ...
        $insertquery ="insert into reg-form(email, password, cpassword, mobile, address, dob) values('$email','$pass','$cpass','$mobile','$address',' $dob')";
